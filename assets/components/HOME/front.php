<div class="front home-front" >
    ...
    <div class="front-content limited">
        ...
        <!-- <div class="movies-design">
            <div class="movie to-be-moved">
                <p class="movie-name">Spider-man1</p>
                <img loading="lazy" src="<?php echo $GLOBAL_VARIABLES['hostName'] ?>/assets/imgs/backgrounds/background-1.webp">
            </div>
            <div class="movie">
                <p class="movie-name">Spider-man2</p>
                <img loading="lazy" src="<?php echo $GLOBAL_VARIABLES['hostName'] ?>/assets/imgs/backgrounds/background-1.webp">
            </div>
            <div class="movie to-be-moved">
                <p class="movie-name">Spider-man3</p>
                <img loading="lazy" src="<?php echo $GLOBAL_VARIABLES['hostName'] ?>/assets/imgs/backgrounds/background-1.webp">
            </div>
        </div> -->
