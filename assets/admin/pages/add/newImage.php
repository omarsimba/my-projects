            ...
            <div class="content_purpos adding_data">
                <div class="row forInputs">
                    ...
                    <form id="add_new_product_form" enctype='multipart/form-data'>
                            ...
                            <div class="row">
                                ...
                                <div class="inputs_group">
                                    ...
                                    <?php
                                        ...
                                        echo inputSelectorChanger($default_text, "status", $this__other_values, 'ri-pulse-line', $title, $default_value);
                                    ?>
                                </div>
                            </div>
                        ...
                        <?php echo btnWithLoader( 'Inser new product', 'ri-shopping-bag-line', 'Adding...', 'Added', 'add_new_product_form', 'admin/php/add_new_product_form', 'add-new-product') ?>
