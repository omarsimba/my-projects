...
showProductDetailsBtns.forEach(showProductDetailsBtn => {
	showProductDetailsBtn.onclick = ()=>{
		...
		const thisReviewerNameHodler = thisUpdateAlert.querySelector('#reviewer-name-holder')
		const thisMailTextHodler = thisUpdateAlert.querySelector('#review-text-holder')
		const reviewSpecialIdHolder = thisUpdateAlert.querySelector('#review_special_id_holder')
		...
		fetch(`${hostName}/assets/admin/php/get_package_details_to_update.php`, {
            ...
            .then((response) => {
                ...
                if (data.success) {
                	var review_details = data.success

                	thisReviewerNameHodler.textContent = review_details.reviewer_name
                	// Change the text container direction
                	// thisMailTextHodler.dir = review_details.direction
                	thisMailTextHodler.textContent = review_details.review_text
                	reviewSpecialIdHolder.value = review_details.special_id
